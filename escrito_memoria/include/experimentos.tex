...
Las tablas~\ref{tab:adf_60s}~\ref{tab:adf_30s} muestran que todas las series no
...
%que se incrementa la frecuencia del resample, no es posible estimar ADF, ya que
%se generan muchas diferencias nulas (NaN).
